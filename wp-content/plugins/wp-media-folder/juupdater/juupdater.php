...
Disconnect my Joomunited account</span>';
        ...
        public function addCheckForUpdatesLink($pluginMeta, $pluginFile)
        {
             ...
             */
            $wpmf_capability = apply_filters('wpmf_user_can', current_user_can('update_plugins'), 'update_plugins');
            if ($isRelevant && $wpmf_capability) {
 ...
 href="%s">%s</a>', esc_attr($link), 'JoomUnited Login');
        ...
        public function handleManualCheck()
        {
            ...
            $shouldCheck = isset($_GET['puc_check_for_updates'], $_GET['puc_slug']) && $_GET['puc_slug'] === $this->slug && $wpmf_capability && check_admin_referer('puc_check_for_updates');
        ...
        protected function isMuPlugin()
        {
            ...
            if ($cachedResult === null) {
                ...
                $pos = strpos(($pluginPath), chr($muPluginDir));
                $cachedResult = ($pos === 0);
            }
