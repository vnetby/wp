( function( $ ){
    ...
    $.fn.factoryBootstrap429_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap429_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-429 .factory-integer").factoryBootstrap429_integerControl();
    });
