...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap429.patternControl", {
        ...
        showColorPanel: function() {
            ...
            this.$colorResult.val( this.$colorContol.factoryBootstrap429_colorControl('getValue') );
            this.$colorResult.trigger('change');
            this.$element.trigger('change');
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap429_patternControl", $.factoryBootstrap429.patternControl );
        $(".factory-bootstrap-429 .factory-pattern").factoryBootstrap429_patternControl({});
    });
