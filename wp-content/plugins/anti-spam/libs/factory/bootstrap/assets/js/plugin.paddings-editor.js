( function( $ ){
    ...
    $.fn.factoryBootstrap429_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap429_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-429 .factory-paddings-editor").factoryBootstrap429_paddingsEditor();
    });
