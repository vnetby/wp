...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap429.colorControl", {
        ...
        _init: function( event ) {
            ...
            this.$picker.factoryBootstrap429_iris(irisOptions); 
            this.$picker.off('focus');

            $(document).on("click.color.factory", function(){
               self.$picker.factoryBootstrap429_iris("hide");  
            });

            this.$picker.add(this.$background).on("click.color.factory", function(e){
               e.stopPropagation();
               self.$picker.factoryBootstrap429_iris("show");  
            });  
        },
        ...
        hidePicker: function() {
            ...
            this.$picker.factoryBootstrap429_iris( 'hide' );
        }, 

        showPicker: function() {
            this.$element.addClass('factory-picker-active');
            this.$picker.factoryBootstrap429_iris( 'show' );
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap429_colorControl", $.factoryBootstrap429.colorControl );
        $(".factory-bootstrap-429 .factory-color").factoryBootstrap429_colorControl({});
    });
